...
**Version:** `0.99.4` (Bioconductor `x.99.y` devel)
...
Core package files: `DESCRIPTION` (version `0.99.4`), `NAMESPACE`, `LICENSE`, `NEWS.md`, `man/`, `vignettes/ClinicalVariantR.Rmd`, `tests/`.
