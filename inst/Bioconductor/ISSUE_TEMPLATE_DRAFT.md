...
ClinicalVariantR is a Bioconductor / Shiny software package for ACMG/AMP
germline variant classification from VEP-, SnpEff-, or ANNOVAR-annotated VCF
files, with streaming support for large call sets and structured
criterion-level evidence export.
